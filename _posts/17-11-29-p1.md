...
cover:  img/posts/17-11-29/17-11-29-b.png
...
<!--more-->
{% include image.html url="/img/posts/17-11-29/17-11-29-i0.png" description="Rigolet, Nunatsiavut in the Autumn" direction="left" width="60%"  figcap="true" %}
...
{% include image.html url="/img/posts/17-11-29/17-11-29-i1.png" description="Exploring the boardwalk - 2017" direction="right" width="40%" figcap="true" %}
...
{% include image.html url="/img/posts/17-11-29/17-11-29-i2.png" description="Left to right: Nic, Jason, Jacquie, and a “metric butt tonne of candy”" direction="left" width="50%" figcap="true" %}
...
{% include image.html url="/img/posts/17-11-29/17-11-29-i3.png" description="Learning from the students at Northern Lights Academy." direction="right" width="50%" figcap="true" %}
...
{% include image.html url="/img/posts/17-11-29/17-11-29-i4.png" description="Post-its: the beginning of an eNuk engagement piece, by Rigolet, for Rigolet." direction="left" width="50%" figcap="true" %}
